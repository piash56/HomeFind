    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title"><b>{{ __('Create Purchase Notification') }}</b></h3>
            ...
            <div class="card o-hidden border-0 shadow-lg">
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <form class="admin-form" action="{{ route('back.purchase-notification.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="minutes_ago" class="form-control" id="minutes_ago"
                                        placeholder="{{ __('Enter Minutes Ago (e.g., 12)') }}" value="{{ old('minutes_ago', 12) }}" min="0" max="999" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sort_order" class="form-control" id="sort_order"
                                        placeholder="{{ __('Enter Sort Order') }}" value="{{ old('sort_order', 0) }}" min="0">
                                    <small class="form-text text-muted">{{ __('Lower numbers appear first') }}</small>
                                </div>

                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="status" id="status" value="1" {{ old('status', true) ? 'checked' : '' }}>
