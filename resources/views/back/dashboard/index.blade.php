                      ...
                      <div class="gd-responsive-table">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  <td>
                                      @php
                                          $billing = json_decode($data->billing_info, true);
                                          $guestName = $billing['bill_first_name'] ?? null;
                                          $userName = optional($data->user)->name ?? optional($data->user)->first_name;
                                      @endphp
                                      {{ $userName ?: $guestName ?: __('Guest') }}
                                  </td>
                                  <td>
