                                                    ...
                                                    <div id="conf" class="container tab-pane active"><br>
                                                        ...
                                                        <div class="row justify-content-center">
                                                            ...
                                                            <div class="col-lg-8">
                                                                ...
                                                                <form action="{{ route('back.setting.update') }}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label class="switch-primary">
                                                                            <input type="checkbox"
                                                                                ...
                                                                                name="is_queue_enabled" value="1"
                                                                                {{ $setting->is_queue_enabled == 1 ? 'checked' : '' }}>
                                                                            <span class="switch-body"></span>
                                                                            <span
                                                                                class="switch-text">{{ __('Mail Using Queue') }}</span>
                                                                        </label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="switch-primary">
                                                                            <input type="checkbox"
                                                                                class="switch switch-bootstrap  "
                                                                                name="order_mail" value="1"
                                                                                {{ $setting->order_mail == 1 ? 'checked' : '' }}>
                                                                            <span class="switch-body"></span>
                                                                            <span
                                                                                class="switch-text">{{ __('After Order Admin Get Mail') }}</span>
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="switch-primary">
                                                                            <input type="checkbox"
                                                                                class="switch switch-bootstrap  "
                                                                                name="ticket_mail" value="1"
                                                                                {{ $setting->ticket_mail == 1 ? 'checked' : '' }}>
                                                                            <span class="switch-body"></span>
                                                                            <span
                                                                                class="switch-text">{{ __('After Ticket Reply Send Mail') }}</span>
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="switch-primary">
                                                                            <input type="checkbox"
                                                                                ...
                                                                                name="is_mail_verify" value="1"
                                                                                {{ $setting->is_mail_verify == 1 ? 'checked' : '' }}>
                                                                            <span class="switch-body"></span>
                                                                            <span
                                                                                class="switch-text">{{ __('Enable Email Verification') }}</span>
                                                                        </label>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="switch-primary">
                                                                            <input type="checkbox"
                                                                                class="switch switch-bootstrap status radio-check"
                                                                                name="smtp_check" value="1"
                                                                                {{ $setting->smtp_check == 1 ? 'checked' : '' }}>
                                                                            <span class="switch-body"></span>
                                                                            <span
                                                                    ...
                                                                    <div
                                                                        class="radio-show {{ $setting->smtp_check == 0 ? 'd-none' : '' }}">

                                                                        <div class="form-group ">
                                                                            <label
                                                                                for="email_host">{{ __('SMTP Host') }}</label>
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <label
                                                                                for="email_port">{{ __('SMTP Port') }}</label>
                                                                            <input type="text" class="form-control "
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <label
                                                                                for="email_encryption">{{ __('SMTP Encryption') }}</label>
                                                                            <input type="text" class="form-control "
                                                                                id="email_encryption"
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <label
                                                                                for="email_user">{{ __('SMTP Username') }}</label>
                                                                            <input type="text" class="form-control "
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <label
                                                                                for="email_pass">{{ __('SMTP Password') }}</label>
                                                                            <input type="text" class="form-control "
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <label
                                                                            for="email_from">{{ __('Email From') }}</label>
                                                                        <input type="text" class="form-control "
                                                                            id="email_from" name="email_from"
                                                                            placeholder="{{ __('Enter Email From') }}"
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <label
                                                                            for="email_from_name">{{ __('Email From Name') }}</label>
                                                                        <input type="text" class="form-control "
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <label
                                                                            for="contact_email">{{ __('Contact Email') }}</label>
                                                                        <input type="text" class="form-control "
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="gd-responsive-table">
                                                                    <table class="table table-bordered table-striped"
                                                                        id="admin-table" width="100%" cellspacing="0">

                                                                        <thead>
                                                                            <tr>
                                                                                <th width="20%">{{ __('Type') }}
                                                                                </th>
                                                                                <th width="20%">{{ __('Subject') }}
                                                                                </th>
                                                                                <th width="15%">{{ __('Actions') }}
                                                                                </th>
                                                                            </tr>
                                                                        </thead>
