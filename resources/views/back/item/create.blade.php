        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        <label class="switch-primary">
                            <input type="checkbox" class="switch switch-bootstrap status radio-check" name="is_featured" value="1" {{old('is_featured') == 1 ? 'checked' : ''}}>
                            <span class="switch-body"></span>
                    ...
                    <div class="form-group mb-3">
                        <label class="switch-primary">
                            <input type="checkbox" class="switch switch-bootstrap status radio-check" name="is_best_selling" value="1" {{old('is_best_selling') == 1 ? 'checked' : ''}}>
                            <span class="switch-body"></span>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        <label class="switch-primary">
                            <input type="checkbox" class="switch switch-bootstrap status radio-check" name="has_separate_delivery" id="has_separate_delivery" value="1" {{ old('has_separate_delivery') == 1 ? 'checked' : '' }}>
                            <span class="switch-body"></span>
                    ...
                    <div id="separate-delivery-section" style="display: {{ old('has_separate_delivery') == 1 ? 'block' : 'none' }};">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="inside_dhaka_delivery_fee">{{ __('Inside Dhaka Delivery Fee') }} ({{ PriceHelper::setCurrencySign() }})</label>
                                    <input type="number" step="0.01" min="0" class="form-control" name="inside_dhaka_delivery_fee" id="inside_dhaka_delivery_fee" value="{{ old('inside_dhaka_delivery_fee', 70) }}" placeholder="70">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control" name="outside_dhaka_delivery_fee" id="outside_dhaka_delivery_fee" value="{{ old('outside_dhaka_delivery_fee', 130) }}" placeholder="130">
