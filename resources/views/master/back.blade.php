        ...
        <div class="main-header ">
            ...
            <div class="logo-header">
                ...
                <a href="{{ route('back.dashboard') }}" class="logo">
                    <img src="{{ $setting->logo ? asset('storage/images/' . $setting->logo) : asset('storage/images/placeholder.png') }}"
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown"
                                ...
                                <div class="avatar-sm avatar avatar-sm">
                                    <img src="{{ Auth::guard('admin')->user()->photo ? asset('storage/images/' . Auth::guard('admin')->user()->photo) : asset('storage/images/noimage.png') }}"
                                ...
                                <li>
                                    <div class="user-box">
                                        <div class="avatar-lg"><img
                                                src="{{ Auth::guard('admin')->user()->photo ? asset('storage/images/' . Auth::guard('admin')->user()->photo) : asset('storage/images/noimage.png') }}"
