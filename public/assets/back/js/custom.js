(function ($) {
  ...
  $(document).on("show.bs.modal", "#statusModal", function (e) {
    var $modal = $(this);
    var baseHref = $(e.relatedTarget).data("href");
    var statusValue = $(e.relatedTarget).data("status-value");
    $modal.find(".btn-ok").attr("href", baseHref);
  ...
  $(function () {
    ...
    $(document).on("click", ".remove-social", function () {
      if (
        $(this).parent().parent().parent().find(".social-picker").length > 1
      ) {
    ...
    $(document).on(
      "change",
      "#category_id1,#category_id2,#category_id3,#category_id4",
      function () {
        let category_id = $(this).val();
        let countNumber = "";
    ...
    $(document).on(
      "change",
      "#subcategory_id1,#subcategory_id2,#subcategory_id3,#subcategory_id4",
      function () {
        let subategory_id = $(this).val();
        let countNumber = "";
        let catId = $(this).attr("id");
    ...
    $(document).on(
      "change",
      "#column_category_id1,#column_category_id2,#column_category_id3",
      function () {
        let category_id = $(this).val();
        let count = "";
        let catId = $(this).attr("id");
    ...
    $(document).on(
      "change",
      "#cloumn_subcategory_id1,#cloumn_subcategory_id2,#cloumn_subcategory_id3",
      function () {
        let subategory_id = $(this).val();
        let count = "";
        let catId = $(this).attr("id");
    ...
    $(document).on(
      "change",
      "#feature_category_id1,#feature_category_id2,#feature_category_id3,#feature_category_id4",
      function () {
        let category_id = $(this).val();
        let count = "";
        let catId = $(this).attr("id");
    ...
    $(document).on(
      "change",
      "#feature_subcategory_id1,#feature_subcategory_id2,#feature_subcategory_id3,#feature_subcategory_id4",
      function () {
        let subategory_id = $(this).val();
        let count = "";
        let catId = $(this).attr("id");
  ...
  $(document).on(
    "change",
    "#transaction-bulk-delete input.bulk-item",
    function () {
